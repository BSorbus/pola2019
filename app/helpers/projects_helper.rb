module ProjectsHelper
  ...
  def project_index_legend
    fa_icon("project-diagram", text: t("pages.project.index.title"))
  end

  def project_edit_legend(data_obj)
  	fa_icon("project-diagram", text: t("pages.project.edit.title") + ": " + data_obj.fullname )
  end

  def project_new_legend(data_obj)
  	fa_icon("project-diagram", text: t("pages.project.new.title"))
  end
