module ErrandsHelper
  ...
  def errand_show_legend
    fa_icon(ICON, text: t("pages.errand.show.title") )
  end

  def errand_index_legend
    fa_icon(ICON, text: t("pages.errand.index.title") )
  end

  def errand_edit_legend(data_obj)
    fa_icon(ICON, text: t("pages.errand.edit.title") + ": " + data_obj.fullname )
  end

  def errand_new_legend(data_obj)
    fa_icon(ICON, text: t("pages.errand.new.title"))
  end
