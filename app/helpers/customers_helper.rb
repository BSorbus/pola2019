module CustomersHelper
  ...
  def customer_index_legend
    fa_icon("flag", text: t("pages.customer.index.title"))
  end

  def customer_edit_legend(data_obj)
    fa_icon("flag", text: t("pages.customer.edit.title") + ": " + data_obj.fullname )
  end

  def customer_new_legend(data_obj)
    fa_icon("flag", text: t("pages.customer.new.title"))
  end
